...
<template>
    ...
    <div class="mx-auto pb-4 pt-3 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <form method="POST" @submit.prevent="submitPicks">
            <div
                class="mb-3 grid grid-cols-1 auto-rows-[minmax(100px,auto)] md:grid-cols-2 xl:grid-cols-4 gap-3 border-b border-gray-400">
                ...
                <div v-if="league.league_type_id !== 2" id="tiebreak-wrap" class="col-span-full">
                    <div class="flex flex-col justify-center items-center">
                        ...
                        <input type="number" id="tiebreaker" min="0" max="120"
                            class="mb-2 px-2 py-1 bg-slate-100 dark:bg-white rounded dark:text-slate-800"
                            v-model="tiebreaker">

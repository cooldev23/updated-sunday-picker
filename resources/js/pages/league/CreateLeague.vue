		...
		<Form v-bind="store()" v-slot="{ errors, processing }"
			...
			<div class="grid gap-6">
				<div class="grid gap-2">
					...
					<Input id="leagueName" type="text" name="leagueName" required autofocus :tabindex="1" autocomplete="leagueName"
						placeholder="League name" />
					<InputError :message="errors.leagueName" />
				</div>
				<div class="grid gap-2">
					<Label for="leagueMotto">Motto</Label>
					<Input id="leagueMotto" type="text" name="leagueMotto" required autofocus :tabindex="1" autocomplete="leagueMotto"
